...
class MyLogin(QMainWindow):
    ...
    def __init__(self):
        ...
        uic.loadUi(r"C:\Users\user\OneDrive - mmu.edu.my\3rd Year\DATABASE\Assignment 1_1\login.ui", self)
        self.show()
...
class MyDashboard(QMainWindow):
    def __init__(self, role, login_window, parent=None):
        ...
        uic.loadUi(r"C:\Users\user\OneDrive - mmu.edu.my\3rd Year\DATABASE\Assignment 1_1\dashboard.ui", self)
        self.role = role
...
class MyRegistration(QMainWindow):
    def __init__(self, dashboard_window, parent=None):
        super().__init__(parent)
        uic.loadUi(r"C:\Users\user\OneDrive - mmu.edu.my\3rd Year\DATABASE\Assignment 1_1\registration.ui", self)
...
class MyNewRegistration(QMainWindow):
    def __init__(self, dashboard_window, parent=None):
        super().__init__(parent)
        uic.loadUi(r"C:\Users\user\OneDrive - mmu.edu.my\3rd Year\DATABASE\Assignment 1_1\newRegistration.ui", self)
        self.dashboard_window = dashboard_window
    ...
    def save_data(self):
        ...
        try:
            conn = sqlite3.connect(r"C:\Users\user\OneDrive - mmu.edu.my\3rd Year\DATABASE\Assignment 1_1\Database\main.db")
            cursor = conn.cursor()
...
class MyPatientRecord(QMainWindow):
    def __init__(self, dashboard_window, parent=None):
        super().__init__(parent)
        uic.loadUi(r"C:\Users\user\OneDrive - mmu.edu.my\3rd Year\DATABASE\Assignment 1_1\patientRecord.ui", self)
        self.dashboard_window = dashboard_window
...
class MyAppointment(QMainWindow):
    def __init__(self, dashboard_window, parent=None):
        super().__init__(parent)
        uic.loadUi(r"C:\Users\user\OneDrive - mmu.edu.my\3rd Year\DATABASE\Assignment 1_1\appointment.ui", self)
        self.dashboard_window = dashboard_window
...
class MyReport(QMainWindow):
    def __init__(self, dashboard_window, parent=None):
        super().__init__(parent)
        uic.loadUi(r"C:\Users\user\OneDrive - mmu.edu.my\3rd Year\DATABASE\Assignment 1_1\report.ui", self)
        self.dashboard_window = dashboard_window
...
class MyBilling(QMainWindow):
    def __init__(self, dashboard_window, parent=None):
        super().__init__(parent)
        uic.loadUi(r"C:\Users\user\OneDrive - mmu.edu.my\3rd Year\DATABASE\Assignment 1_1\billing.ui", self)
        self.dashboard_window = dashboard_window
...
class MyPharmacy(QMainWindow):
    def __init__(self, dashboard_window, parent=None):
        super().__init__(parent)
        uic.loadUi(r"C:\Users\user\OneDrive - mmu.edu.my\3rd Year\DATABASE\Assignment 1_1\pharmacy.ui", self)
        self.dashboard_window = dashboard_window
